            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="number" name="jurusan" class="form-control" value="{{ $user->profile->jurusan }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="number" name="daerah" class="form-control" value="{{ $user->profile->daerah }}">
