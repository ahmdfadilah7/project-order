                ...
                <div class="card profile-widget">
                    ...
                    <div class="profile-widget-description">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Tempat Lahir</td>
                                <td>: {{ $user->profile->tmpt_lahir }}</td>
                            </tr>
                            <tr>
                                <td>Tanggal Lahir</td>
                                <td>: {{ \Carbon\Carbon::parse($user->profile->tgl_lahir)->format('d M Y') }}</td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                                <td>
                                    : 
                                    @if($user->profile->jns_kelamin <> '')
                                        @if($user->profile->jns_kelamin == 'l')
                                            Laki - Laki
                                        @else
                                            Perempuan
                                        @endif
                        ...
                        <a href="{{ route('admin.penjoki.edit', $user->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a>
                    </div>
                </div>
            </div>
