...
class FileProjectController extends Controller
{
    public function listData($id) {
        ...
        $datatables = DataTables::of($data)
            ...
            ->addColumn('action', function($row) {
                $btn = '<a href="'.route('penjoki.fileproject.delete', $row->id).'" class="btn btn-danger btn-sm mr-2 mb-2">
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('penjoki.order.detail', $request->project_id)->with('berhasil', 'Berhasil menambahkan file project.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('penjoki.order.detail', $fileproject->project_id)->with('berhasil', 'Berhasil menghapus file project.');
    }
}
