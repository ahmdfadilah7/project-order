...
class FileProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pelanggan.order.detail', $request->order_id)->with('berhasil', 'Berhasil menambahkan file project.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pelanggan.order.detail', $fileproject->order_id)->with('berhasil', 'Berhasil menghapus file project.');
    }
}
